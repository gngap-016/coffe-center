                    ...
                    <div class="card me-4 mb-4" style="width: 250px;">
                        <div class="card-body">
                            ...
                            <div class="d-grid gap-2">
                                <button class="btn btn-secondary" type="button" onclick="addToCart({{$d}})">Tambah keranjang</button>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                @if ($d->raw == 1)
                    <div class="card me-4 mb-4" style="width: 250px;">
                        <div class="card-body">
                            ...
                            <p class="text-price mb-2">Rp{{ number_format($d->price) }}<span class="fs-6 text-category">/bibit</span></p>
                            <p class="fw-bold mb-2">{{ $d->name }}</p>
